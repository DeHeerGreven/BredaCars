...
<body style='font-family: "Bebas Neue", sans-serif;'>
    ...
    <div class="hero bg-slate-100">
        <div class="hero-content text-center mt-4">
          <div class="max-w-md">
            <h1 class="text-6xl font-regular">Maak een afspraak</h1>
            <p class="py-6 font-light text-xl">Maak hier op deze pagina een afpsraak</p>
          </div>
        </div>
    </div>
        ...
        <form action="{{route('appointments.store')}}" method="POST" class="p-12 mx-64">
            ...
            <div class="grid grid-cols-1 gap-10">
                <div class="card bg-white p-8">
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="first_name">
                            Voornaam
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="infix">
                            Tussenvoegsel
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="last_name">
                            Achternaam
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="email">
                            Email
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="street">
                            Straatnaam
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="house_number">
                            Huisnummer
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="postal_code">
                            Postcode
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="city">
                            Plaatsnaam
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="phone_number">
                            Telefoonummer
                        </label>
                ...
                <div class="card bg-white p-8">
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="brand">
                            Merk
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="model">
                            Model
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="description">
                            Wat is het probleem?
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="license_plate">
                            Kenteken
                        </label>
                    ...
                    <div class="mt-2">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="transaction">
                            Transactie
                        </label>
                    ...
                    <div class="mt-2">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="fuel">
                            Brandstof
                        </label>
                    ...
                    <div class="mt-2">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="color">
                            Kleur
                        </label>
                    ...
                    <div class="">
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2" for="appointment_type">
                            Type afspraak
                        </label>
                    ...
                    <div>
                        <label class="block uppercase tracking-wide text-gray-700 text-lg font-light mb-2 mt-4" for="appointment_date">
                ...
                <div class="flex justify-center">
                    <button type="submit" class="mt-4 inline-block border-2 border-red-600 hover:bg-red-600 hover:text-white duration-200 text-black text-xl font-light py-2 px-8 rounded-full">Afspraak maken</button>
                </div>
            </div>
        </form>
    </div>
